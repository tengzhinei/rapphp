...
class Http
{
     ...
     * @return HttpResponse
     */
    public static function get($url, $header = [], $timeout = 5)
    {
     ...
     * @return HttpResponse
     */
    public static function form($url, $header = [], $data = [], $timeout = 5){
     ...
     * @return HttpResponse
     */
    public static function post($url, $header = [], $data = [], $timeout = 5)
    {
     ...
     * @return HttpResponse
     */
    public static function put($url, $header = [], $data = [], $timeout = 5)
    {
     ...
     * @return HttpResponse
     */
    public static function upload($url, $header = [], $data = [], $files = [], $timeout = 60)
    {
     ...
     * @return HttpResponse
     */
    public static function delete($url, $header=[], $data=[], $timeout=5){
